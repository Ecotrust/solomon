...
urlpatterns = patterns('',
    ...
    (r'/crosstab/(?P<survey_slug>[\w\d-]+)/(?P<question_a_slug>[\w\d-]+)/(?P<question_b_slug>[\w\d-]+).json', get_crosstab_json),
    ...
    url(r'/surveyor-stats/(?P<survey_slug>[\w\d-]+)/(?P<interval>[\w]+).json', surveyor_stats_json, name='reports_surveyor_stats_json'),
