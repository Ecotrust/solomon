...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.user_agent'
        db.add_column(u'survey_response', 'user_agent',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.user_agent'
        db.delete_column(u'survey_response', 'user_agent')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'39a77e88-3939-47e8-91a3-20bfdf4b4900'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
