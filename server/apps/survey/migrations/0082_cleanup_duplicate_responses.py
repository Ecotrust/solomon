...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        i = 1
        count = orm['survey.Respondant'].objects.all().count()
        for r in orm['survey.Respondant'].objects.all():
            print "cleaning duplicates from response %d of %d " % (i, count)
            i += 1
            for question in r.response_set.values('question__slug', 'question__type').distinct():
                ...
                if responses.count() > 1:
                    answers = responses.values('answer').distinct()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a4882a1c-6558-4c86-845d-5568d4c6ea99'", 'max_length': '36', 'primary_key': 'True'}),
