...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.test_data'
        db.add_column(u'survey_respondant', 'test_data',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.test_data'
        db.delete_column(u'survey_respondant', 'test_data')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 13, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d9dea145-5fda-43c3-914a-e72f35c2060b'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
