...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Respondant.vendor'
        db.add_column(u'survey_respondant', 'vendor',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.survey_site'
        db.add_column(u'survey_respondant', 'survey_site',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Respondant.vendor'
        db.delete_column(u'survey_respondant', 'vendor')

        # Deleting field 'Respondant.survey_site'
        db.delete_column(u'survey_respondant', 'survey_site')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'21dc3ab8-6fb2-46e6-b4d7-37d4c823ce5d'", 'max_length': '36', 'primary_key': 'True'}),
