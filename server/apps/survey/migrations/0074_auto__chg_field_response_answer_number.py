...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.answer_number'
        db.alter_column(u'survey_response', 'answer_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Response.answer_number'
        db.alter_column(u'survey_response', 'answer_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2971531f-c06b-45d9-bb3e-087d83aaba60'", 'max_length': '36', 'primary_key': 'True'}),
