...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for question in orm.Question.objects.all():
            if question.skip_question:
                block, created = orm.Block.objects.get_or_create(name="%s %s" % (question.skip_question.slug,question.skip_condition),
                    skip_question=question.skip_question, skip_condition=question.skip_condition)
                question.blocks.add(block)
                question.skip_condition = None
                question.skip_question = None
                question.save()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 10, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ff02e810-0195-4155-9b7b-1175940a11d9'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
