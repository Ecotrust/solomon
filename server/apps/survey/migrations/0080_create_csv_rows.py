...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for respondant in orm.Respondant.objects.all():
            respondant.save()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b6ac6979-abb4-4ca9-bfc6-2df22e19f3f2'", 'max_length': '36', 'primary_key': 'True'}),
