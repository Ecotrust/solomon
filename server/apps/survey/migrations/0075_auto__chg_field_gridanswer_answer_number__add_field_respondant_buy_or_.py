...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GridAnswer.answer_number'
        db.alter_column(u'survey_gridanswer', 'answer_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))
        # Adding field 'Respondant.buy_or_catch'
        db.add_column(u'survey_respondant', 'buy_or_catch',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.how_sold'
        db.add_column(u'survey_respondant', 'how_sold',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GridAnswer.answer_number'
        db.alter_column(u'survey_gridanswer', 'answer_number', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7))
        # Deleting field 'Respondant.buy_or_catch'
        db.delete_column(u'survey_respondant', 'buy_or_catch')

        # Deleting field 'Respondant.how_sold'
        db.delete_column(u'survey_respondant', 'how_sold')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 14, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0c8a2dcd-93e0-45a5-8486-22def695ce4d'", 'max_length': '36', 'primary_key': 'True'}),
