...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GridAnswer.answer_number'
        db.add_column(u'survey_gridanswer', 'answer_number',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GridAnswer.answer_number'
        db.delete_column(u'survey_gridanswer', 'answer_number')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 14, 0, 0)'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b336fad7-9e1d-4d14-9a9a-7307341f28d3'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
