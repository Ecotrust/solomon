...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_response', 'updated_at',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_response', 'updated_at')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'efa85a12-af2c-4d10-ba82-fd5e1f963447'", 'max_length': '36', 'primary_key': 'True'}),
